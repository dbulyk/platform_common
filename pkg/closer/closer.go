...
// Add добавляет коллбек на добавление в глобальный closer
func Add(f ...func() error) {
	globalCloser.Add(f...)
}

// Wait блокируется пока все коллбеки не отработают
func Wait() {
	globalCloser.Wait()
}

// CloseAll закрывает все соединения глобального объекта
func CloseAll() {
